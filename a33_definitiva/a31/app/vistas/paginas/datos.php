...
require_once "../app/vistas/inc/header.php";
 ...
 ?>
<a href="<?php echo RUTA_URL; ?>/paginas/datos/<?php echo $datos["id_usuario"] ?>" class="btn btn-light"><i class="fa fa-backward"> Volver</i></a>
<div class="card card-body bg-light mt-5">
    <h2>Editar usuariossss</h2>
    <form action="<?php echo RUTA_URL; ?>/paginas/datos/<?php echo $datos['id_usuario']?>" method="POST">
        ...
        <input type="submit" class="btn btn-success" name="envia" value="Generar PDF">
    </form>
</div>    
